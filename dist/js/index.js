...
/* harmony import */ var swiper_swiper_bundle__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! swiper/swiper-bundle */ "./node_modules/swiper/swiper-bundle.js");
/* harmony import */ var swiper_swiper_bundle__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(swiper_swiper_bundle__WEBPACK_IMPORTED_MODULE_2__);




(function () {
  var typingEls = (0,_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__.default)(document.querySelectorAll('.typing'));

  typingEls.forEach(function (el) {
    var delay = el.dataset.delay;
    var words = el.dataset.words;
    words = words.split(',');
    el.style.animationDuration = "".concat(delay, "ms");
    var indexCurrentWord = 0,
        indexCurrentChar = 0;
...
new (swiper_swiper_bundle__WEBPACK_IMPORTED_MODULE_2___default())('.swiper-quotes .swiper-container', {
  slidesPerView: 1.33,
  spaceBetween: 24,
  loop: true,
  navigation: {
...
new (swiper_swiper_bundle__WEBPACK_IMPORTED_MODULE_2___default())('.swiper-cases .swiper-container', {
  slidesPerView: 1,
  spaceBetween: 24,
  loop: true,
  navigation: {
